...
+ Aan de slag {#getting-started}
   ...
   + Verzenden {#getting-started-sending}
      ...
      + [Een document naar één ondertekenaar sturen](sign-beginner-tutorials/send-to-single-recipient.md)
      + [Versturen naar meerdere ondertekenaars](sign-beginner-tutorials/send-to-multiple-recipients.md)
...
+ Beheerder {#admin-set-up}
   ...
   + Aan de slag {#getting-started-admin}
      ...
      + [Regels voor automatische gebruikerstoewijzingen inschakelen](admin/automatic-assignment-rules.md)
...
+ Mobiel {#mobile}
   ...
   + Mobiele zelfstudies {#mobile-tutorials}
      ...
      + [Mobielvriendelijke weergave](mobile/mobile-friendly.md)
      + [Mobielvriendelijke weergave maken](mobile/create-mobile-friendly.md)
