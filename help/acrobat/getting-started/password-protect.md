...
<tr>
  <td>
    <a href="password-protect.md">
      <img alt="Een PDF beveiligen met een wachtwoord" src="../assets/protect.png" />
    </a>
    <div>
    <a href="password-protect.md"><strong> Protect a PDF met een wachtwoord </strong></a>
    </div>
    <em> Leer hoe te om een wachtwoord aan uw PDF toe te voegen </em>
    <br>
  </td>
  <td>
