...
<tr>
  ...
  <td>
    <a href="lob/hr/hr-overview.md">
      <img alt="HR-praktijkvoorbeelden" src="../assets/use-case-hr.png" />
    </a>
    <div>
    <a href="lob/hr/hr-overview.md"><strong> de gebruiksgevallen van de Financiën </strong></a>
    </div>
    <em> Onderzoek hoe de teams van u Acrobat gebruiken om documenten en workflows over de werknemerslevenscyclus te beheren </em>
    <br>
  </td>
  <td>
